...
def ask(body: QueryWithConsigneeBody):
    ...
    if any(q_lower == word or q_lower.startswith(word + " ") or q_lower.startswith(word + ",") for word in greetings):
        return {
    ...
    # Thanks
    if any(word in q_lower for word in ["thank", "thx", "thanks", "thank you", "ty", "much appreciated"]):
        return {
    ...
    # Who are you
    if "who are you" in q_lower or "your name" in q_lower or "what is your name" in q_lower or "what's your name" in q_lower:
        return {
    ...
    # Farewells
    if any(word in q_lower for word in ["bye", "goodbye", "see you", "take care", "cya", "see ya", "good bye"]):
        return {
    ...
    try:
        ...
        response_message = message if is_milestone_response else sanitize_response(message)
